...
function Collapse({titre,contenu}) {
    ...
    return estOuvert ? (
        <div className='conteneurMenuDeroulant'>
            <div className='conteneurMenuDeroulantTitre'>
                <h2 className='menuDeroulantTitre'>{titre}</h2>
            ...
            <div className='menuDeroulantTexte'>
                <p className='menuDeroulantContenu'>{contenu}</p>
            </div>
        </div>
        ) : (
        <div className='conteneurMenuDeroulant'>
